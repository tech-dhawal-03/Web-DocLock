...
function useControlled({
  ...
  } = React27.useRef(controlled !== void 0);
  const [valueState, setValue] = React27.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React27.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
var ThemeContext2 = React30.createContext(null);
if (true) {
...
function useTheme4() {
  const theme = React31.useContext(ThemeContext_default);
  if (true) {
...
var RtlContext = React33.createContext();
...
var useRtl = () => {
  const value = React33.useContext(RtlContext);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-PJ4U5QLJ.js.map
