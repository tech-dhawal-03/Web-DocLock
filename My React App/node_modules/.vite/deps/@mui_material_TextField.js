...
import {
  ...
  useTheme_default,
  useTimeout
} from "./chunk-PJ4U5QLJ.js";
import "./chunk-6P5UQFZV.js";
import {
  require_jsx_runtime
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime20.jsxs)(React19.Fragment, {
...
var Portal = React20.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React20.isValidElement(children) ? children.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime21.jsx)(React20.Fragment, {
      children
    });
  }
  return (0, import_jsx_runtime21.jsx)(React20.Fragment, {
...
var Paper = React25.forwardRef(function Paper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime26.jsx)(PaperRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
var Popover = React26.forwardRef(function Popover2(inProps, ref) {
  ...
  const {
    ...
    disableScrollLock = false
  } = props, TransitionProps = _objectWithoutPropertiesLoose(props.TransitionProps, _excluded18), other = _objectWithoutPropertiesLoose(props, _excluded22);
  ...
  return (0, import_jsx_runtime27.jsx)(RootSlot, _extends({}, rootProps, !isHostComponent_default(RootSlot) && {
    slotProps: rootSlotPropsProp,
    disableScrollLock
  }, {
    children: (0, import_jsx_runtime27.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime27.jsx)(PaperSlot, _extends({}, paperProps, {
        children
      }))
    }))
  }));
...
var Menu = React27.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime28.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime28.jsx)(MenuMenuList, _extends({
...
var _excluded20 = ["className", "disabled", "error", "IconComponent", "inputRef", "variant"];
...
var NativeSelectInput = React28.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime30.jsxs)(React28.Fragment, {
    children: [(0, import_jsx_runtime29.jsx)(NativeSelectSelect, _extends({
      ownerState,
      className: clsx_default(classes.select, className),
      disabled,
      ref: inputRef || ref
    }, other)), props.multiple ? null : (0, import_jsx_runtime29.jsx)(NativeSelectIcon, {
      as: IconComponent,
      ownerState,
...
var _span3;
var _excluded21 = ["aria-describedby", "aria-label", "autoFocus", "autoWidth", "children", "className", "defaultOpen", "defaultValue", "disabled", "displayEmpty", "error", "IconComponent", "inputRef", "labelId", "MenuProps", "multiple", "name", "onBlur", "onChange", "onClose", "onFocus", "onOpen", "open", "readOnly", "renderValue", "SelectDisplayProps", "tabIndex", "type", "value", "variant"];
...
var SelectInput = React29.forwardRef(function SelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime32.jsxs)(React29.Fragment, {
    children: [(0, import_jsx_runtime31.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty2(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span3 || (_span3 = (0, import_jsx_runtime31.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
    })), (0, import_jsx_runtime31.jsx)(SelectNativeInput, _extends({
      "aria-invalid": error,
      ...
      autoFocus,
      ownerState
    }, other)), (0, import_jsx_runtime31.jsx)(SelectIcon, {
      as: IconComponent,
      className: classes.icon,
      ownerState
    }), (0, import_jsx_runtime31.jsx)(Menu_default, _extends({
      id: `menu-${name || ""}`,
...
var _excluded24 = ["children", "className", "color", "component", "fontSize", "htmlColor", "inheritViewBox", "titleAccess", "viewBox"];
...
var SvgIcon = React30.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime34.jsxs)(SvgIconRoot, _extends({
    as: component,
    className: clsx_default(classes.root, className),
    focusable: "false",
    color: htmlColor,
    ...
    ownerState,
    children: [hasSvgAsChild ? children.props.children : children, titleAccess ? (0, import_jsx_runtime33.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  function Component(props, ref) {
    return (0, import_jsx_runtime35.jsx)(SvgIcon_default, _extends({
...
var Select = React33.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime37.jsx)(React33.Fragment, {
    children: React33.cloneElement(InputComponent, _extends({
...
var TextField = React34.forwardRef(function TextField2(inProps, ref) {
  ...
  const InputElement = (0, import_jsx_runtime38.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime39.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime38.jsx)(InputLabel_default, _extends({
      htmlFor: id,
      id: inputLabelId
    }, InputLabelProps, {
      children: label
    })), select ? (0, import_jsx_runtime38.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime38.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
