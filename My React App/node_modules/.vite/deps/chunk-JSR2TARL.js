...
var React3, import_react, EmotionCacheContext, CacheProvider, withEmotionCache, ThemeContext, getTheme, createCacheWithTheme, hasOwn, typePropName, labelPropName, Insertion, Emotion;
...
var React4, import_hoist_non_react_statics2, isDevelopment3, pkg, warnedAboutCssPropForGlobal, Global, keyframes, classnames, Insertion3, ClassNames, isBrowser2, isTestEnv, globalContext, globalKey;
...
var React6, import_prop_types2, import_jsx_runtime, cache;
...
var React7, import_prop_types3, import_jsx_runtime2;
...
function useControlled({
  ...
  } = React21.useRef(controlled !== void 0);
  const [valueState, setValue] = React21.useState(defaultProp);
  ...
  const setValueIfUncontrolled = React21.useCallback((newValue) => {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
function createGrid(options = {}) {
  ...
  const GridOverflowContext = React33.createContext(void 0);
  if (true) {
  ...
  const Grid2 = React33.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React33.useContext(GridOverflowContext);
    const {
      className,
      children: children2,
    ...
    let result = (0, import_jsx_runtime14.jsx)(GridRoot, _extends({
      ...
      children: React33.Children.map(children2, (child) => {
        if (React33.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
true ? Grid.propTypes = {
   ...
   * ```
   */
  unstable_level: import_prop_types19.default.number,
  /**
...
function joinChildren(children2, separator) {
  const childrenArray = React34.Children.toArray(children2).filter(Boolean);
...
true ? Stack.propTypes = {
   ...
   * @default false
   */
  useFlexGap: import_prop_types21.default.bool
} : void 0;
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JSR2TARL.js.map
